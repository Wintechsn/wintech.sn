...
const TEMOIGNAGES = [
  ...
  {
    quote:
      "« Toujours un plaisir de collaborer avec Wintech. Leur professionnalisme et leur dévouement garantissent un travail digital de grande qualité. Merci pour ce service exceptionnel »",
    name: "Issa Ndiaye",
    role: "CVO Ovindi",
        ...
        <div className="container">
          <div className="flex flex-col justify-center gap-10 md:gap-20">
            <div className="mx-auto max-w-2xl flex items-center text-center">
              <h2>
                <TextGenerateEffect words="Ce que nos clients satisfaits disent" />
                <TextGenerateEffect
                  words="de nous"
                  delay={1}
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <h3 className="dark:text-dark_black text-2xl">
                      Nos clients recommandent nos services de design.
                    </h3>
                  </div>
                </motion.div>
              </div>
