  ...
  return (
    <div className="pb-10 md:scroll-m-[130px] scroll-m-28" id="start">
      ...
      <div className="p-6 rounded-md border mt-6 border-border dark:border-dark_border">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-grey">
          Open package folder and install its dependencies. We recommended npm,
          yarn or pnpm.{" "}
        </p>
        <h6 className="mt-4 mb-2 dark:text-white text-dark font-medium text-base">
          1) Install with npm:
      ...
      <div className="p-6 rounded-md border mt-6 border-border dark:border-dark_border">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-grey mb-4">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-grey my-4">
          This command will start a local webserver{" "}
          <span className="dark:text-white">http://localhost:3000:</span>
        </p>
        <div className="py-4 px-3 rounded-md bg-black">
          <p className="text-sm text-gray-400">{"> wintech_project@1.0.0 dev"}</p>
          <p className="text-sm text-gray-400 mt-1">{"> next dev"}</p>
          <p className="text-sm text-gray-400 mt-6">{"-Next.js 16.1.6"}</p>
      ...
      <div className="p-6 rounded-md border mt-6 border-border dark:border-dark_border">
        ...
        <p className="text-base font-medium text-midnight_text dark:text-grey mt-6">
